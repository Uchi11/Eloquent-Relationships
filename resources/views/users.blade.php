...
<body>
<!-- Relasi One-to-One (Satu ke Satu) adalah jenis hubungan dalam basis data 
     di mana satu entitas (baris) di tabel pertama hanya dapat berhubungan
     dengan satu entitas (baris) di tabel kedua, dan sebaliknya. -->
    <div class="container">
        <div class="card mt-5">
            <div class="card-body">
